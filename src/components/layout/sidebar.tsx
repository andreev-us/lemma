...
export function Sidebar() {
  ...
  return (
    <div className="hidden border-2 border-slate-100 bg-slate-50/50 lg:block lg:w-64 lg:fixed lg:left-4 lg:top-4 lg:bottom-4 lg:z-50 lg:rounded-2xl shadow-sm">
      <div className="flex h-full flex-col">
        <div className="flex pt-8 pb-2 items-center pl-[72px] pr-6">
          ...
          >
            <Logo className="h-10 w-auto" theme={activeTheme} />
          </Link>
        </div>
